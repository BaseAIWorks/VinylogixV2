  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        {/*
          Favicon + apple-touch-icon are auto-generated by Next.js app router
          from src/app/icon.png and src/app/apple-icon.png — do not add manual
          <link rel="icon"> tags here, they would duplicate or conflict.
        */}
